...
use commands::settings::{
    ...
    set_notes_list_layout, set_remember_app_layout, set_remember_settings, set_search_is_fuzzy,
    set_search_mode, set_search_selected_tag, set_sidebar_open, switch_notes_folder, update_config,
};
